    ...
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="text-center mb-12 sm:mb-16 md:mb-20">
        <div className="inline-block mb-6 sm:mb-8">
          <h1 className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 rounded-xl sm:rounded-2xl border-2 border-purple-200 shadow-lg">
            FAQ Insights
          </h1>
        </div>
            ...
            >
              <div className="flex-1 pr-4">
                <h3 className={`text-base sm:text-lg md:text-xl lg:text-2xl font-semibold leading-tight transition-colors duration-300
                  ${activeIndex === index ? 'text-white' : 'text-gray-900 group-hover:text-purple-600'}
                `}>
                  {item.question}
                </h3>
              </div>
              ...
              <div className="px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8 pt-0">
                <div className={`border-t pt-4 sm:pt-6 md:pt-8 ${
                  ...
                  <p className={`text-sm sm:text-base md:text-lg leading-relaxed ${
                    activeIndex === index ? 'text-purple-50' : 'text-gray-600'
                  }`}>
                    {item.answer}
                  </p>
                </div>
